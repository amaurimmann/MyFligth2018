...
public class GerenciadorRotas {
	...
	public void ordenarOrigemCias() {
		/*
		 * rotas.sort((Rota r1, Rota r2) -> { int res =
		 * r1.getOrigem().getNome().compareTo(r2.getOrigem().getNome()); if (res
		 * != 0) // não empatou no nome da origem... return res; // empatou,
		 * desempata pelo nome da cia. return
